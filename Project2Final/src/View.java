...
public class View extends JFrame {
	...
	private static Publications pub = new Publications();
		...
		public View() throws IOException {
			...
			JButton btnAuthors = new JButton("Authors/Bibliographic");
			btnAuthors.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					pub.sortAuthors();
				}
			});
			btnAuthors.setBounds(527, 77, 197, 29);
...
ArrayList<int[]> years = countYears(pub.searchAuthor(search)); //get data from author
			...
			btnFindAuthors.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) 
				{
					...
					else if(pub.searchAuthor(search) == null){
						JOptionPane.showMessageDialog(null, "Author Not Found", "", JOptionPane.INFORMATION_MESSAGE);
					}
					else
					{
					search.trim();
			...
			btnExit.setBounds(527, 118, 197, 29);
